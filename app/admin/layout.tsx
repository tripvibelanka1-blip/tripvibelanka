  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col md:flex-row text-slate-900 font-sans antialiased">
      ...
      >
        ...
        {/* Bottom Sidebar: System & Live Site */}
        <div className="p-3 border-t border-slate-100 space-y-2 bg-slate-50/50">
          <div className="px-3 py-2 rounded-xl bg-white border border-slate-200/70 text-[11px] text-slate-600 space-y-1.5">
          ...
          <Link
            href="/"
            target="_blank"
            className="flex items-center justify-between px-3 py-2 rounded-xl text-xs font-semibold text-slate-600 hover:text-slate-900 hover:bg-white hover:border hover:border-slate-200/80 transition-all"
          >
